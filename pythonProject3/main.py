...
def get_new_contact(edit, modifying_contact):
    ...
    while not is_valid_phone:
        try:
            ...
            continue
        is_valid_phone = True
    return {"Имя": first_name, "Фамилия": last_name, "Отчество": second_name, "Телефон": phone_number}


male_names = ["Иван", "Андрей", "Виталий", "Петр", "Павел", "Григорий","Даниил","Виктор"]
...
fem_names = ["Анна", "Анастасия", "Валерия", "Ольга", "Екатерина", "Виктория","Алина"]
...
def get_random_contact():
    ...
    return {"Имя": name, "Фамилия" : last_name, "Отчество": second_name , "Телефон": phone}
